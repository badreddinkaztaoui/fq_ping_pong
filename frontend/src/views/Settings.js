...
export class SettingsView extends View {
                        ...
                        <div class="security-box">
                            <div class="security-header">
                                <div class="security-status ${
                                  !is42User && this.user.is_2fa_enabled
                                    ? "enabled"
                                    : ""
                                }">
  ...
  setupFormValidation() {
    ...
    this.addListener(username, "input", () => {
      this.state.state.formChanges.username =
  ...
  updateSaveButtonState() {
    ...
    const hasChanges = Object.values(this.state.state.formChanges).some(
      (value) => value
    );
  ...
  setup2FA() {
    ...
    this.addListener(setup2FAButton, "click", async () => {
      if (this.user.username.startsWith("42_")) {
        this.showError(
          "Two-factor authentication is managed through your 42 account settings."
        );
        return;
      }
  ...
  updateSecurityBox() {
    ...
    setup2FAButton.querySelector(".btn-content").textContent = this.user
      .is_2fa_enabled
      ? "DISABLE 2FA"
      : "ENABLE 2FA";
  }
